...
#include <memory>
#include "../../../six/client/application.h"
...
QT_MOC_LITERAL(12, 19), // "onRecieveFromServer"
QT_MOC_LITERAL(32, 0), // ""
QT_MOC_LITERAL(33, 3), // "msg"
QT_MOC_LITERAL(37, 14) // "onSendToServer"

    },
    "Application\0onRecieveFromServer\0\0msg\0"
    "onSendToServer"
};
...
void Application::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onRecieveFromServer((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1]))); break;
        case 1: _t->onSendToServer((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
}

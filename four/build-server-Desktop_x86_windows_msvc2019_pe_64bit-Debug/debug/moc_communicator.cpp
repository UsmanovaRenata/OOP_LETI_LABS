...
#include <memory>
#include "../../../six/common/communicator.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Communicator_t, stringdata0) + ofs), len 
...
QT_MOC_LITERAL(27, 20), // "readPendingDatagrams"
QT_MOC_LITERAL(48, 15) // "sendTheDatagram"

    },
    "Communicator\0recieved\0\0msg\0"
    "readPendingDatagrams\0sendTheDatagram"
};
...
void Communicator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->sendTheDatagram((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Communicator::recieved)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Communicator::staticMetaObject = { {
    ...
    qt_meta_stringdata_Communicator.offsetsAndSize,
    qt_meta_data_Communicator,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Communicator_t
, QtPrivate::TypeAndForceComplete<Communicator, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<QByteArray, std::false_type>

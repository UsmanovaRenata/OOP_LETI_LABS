...
#include <memory>
#include "../../../six/server/application.h"
...
QT_MOC_LITERAL(12, 19), // "onRecieveFromClient"
QT_MOC_LITERAL(32, 0), // ""
QT_MOC_LITERAL(33, 3) // "msg"

    },
    "Application\0onRecieveFromClient\0\0msg"
};
...
void Application::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onRecieveFromClient((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1]))); break;
        default: ;
        }
    }
}

...
{
    QString msg = QString().setNum(mode) + ";";
    msg += QString::fromStdString(std::to_string(matrixSize));
...
void MainWindow::on_d_mode_clicked()
{
    mode = D_MODE;
}


void MainWindow::on_c_mode_clicked()
{
    mode = C_MODE;
}


void MainWindow::on_r_mode_clicked()
{
    mode = R_MODE;
}
